...
#import "XYJSRPinningSecurityPolicy.h"
...
@interface XYJSRPinningSecurityPolicy ()

@property (nonatomic, copy, readonly) NSArray *pinnedCertificates;

@end

@implementation XYJSRPinningSecurityPolicy
...
{
    XYJSRDebugLog(@"Pinned cert count: %d", self.pinnedCertificates.count);
