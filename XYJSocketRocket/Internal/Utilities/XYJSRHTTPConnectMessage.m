...
static NSString *XYJ_SRHTTPConnectMessageHost(NSURL *url)
{
...
CFHTTPMessageRef XYJSRHTTPConnectMessageCreate(NSURLRequest *request,
                                            ...
                                            NSArray<NSString *> *_Nullable requestedProtocols)
{
    ...
    CFHTTPMessageSetHeaderFieldValue(message, CFSTR("Host"), (__bridge CFStringRef)XYJ_SRHTTPConnectMessageHost(url));
    ...
    NSString *basicAuthorizationString = XYJSRBasicAuthorizationHeaderFromURL(url);
    ...
    CFHTTPMessageSetHeaderFieldValue(message, CFSTR("Origin"), (__bridge CFStringRef)XYJSRURLOrigin(url));
