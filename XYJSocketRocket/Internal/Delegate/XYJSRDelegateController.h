...
#import <XYJSocketRocket/XYJSRWebSocket.h>

NS_ASSUME_NONNULL_BEGIN

#if OBJC_BOOL_IS_BOOL

struct XYJSRDelegateAvailableMethods {
...
typedef struct XYJSRDelegateAvailableMethods XYJSRDelegateAvailableMethods;

typedef void(^XYJSRDelegateBlock)(id<XYJSRWebSocketDelegate> _Nullable delegate, XYJSRDelegateAvailableMethods availableMethods);

@interface XYJSRDelegateController : NSObject

@property (nonatomic, weak) id<XYJSRWebSocketDelegate> delegate;
@property (atomic, readonly) XYJSRDelegateAvailableMethods availableDelegateMethods;
