...
@interface XYJSRDelegateController ()

@property (nonatomic, strong, readonly) dispatch_queue_t accessQueue;

@property (atomic, assign, readwrite) XYJSRDelegateAvailableMethods availableDelegateMethods;

@end

@implementation XYJSRDelegateController
...
- (void)setDelegate:(id<XYJSRWebSocketDelegate> _Nullable)delegate
{
    dispatch_barrier_async(self.accessQueue, ^{
        ...
        self.availableDelegateMethods = (XYJSRDelegateAvailableMethods){
...
{
    __block id<XYJSRWebSocketDelegate> delegate = nil;
...
- (void)performDelegateBlock:(XYJSRDelegateBlock)block
{
    __block __strong id<XYJSRWebSocketDelegate> delegate = nil;
    __block XYJSRDelegateAvailableMethods availableMethods = {};
    dispatch_sync(self.accessQueue, ^{
