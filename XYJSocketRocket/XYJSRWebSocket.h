...
typedef NS_ENUM(NSInteger, XYJSRReadyState) {
    XYJSR_CONNECTING   = 0,
    XYJSR_OPEN         = 1,
    XYJSR_CLOSING      = 2,
    XYJSR_CLOSED       = 3,
...
typedef NS_ENUM(NSInteger, XYJSRStatusCode) {
    // 0-999: Reserved and not used.
    XYJSRStatusCodeNormal = 1000,
    XYJSRStatusCodeGoingAway = 1001,
    XYJSRStatusCodeProtocolError = 1002,
    XYJSRStatusCodeUnhandledType = 1003,
    // 1004 reserved.
    XYJSRStatusNoStatusReceived = 1005,
    XYJSRStatusCodeAbnormal = 1006,
    XYJSRStatusCodeInvalidUTF8 = 1007,
    XYJSRStatusCodePolicyViolated = 1008,
    XYJSRStatusCodeMessageTooBig = 1009,
    XYJSRStatusCodeMissingExtension = 1010,
    XYJSRStatusCodeInternalError = 1011,
    XYJSRStatusCodeServiceRestart = 1012,
    XYJSRStatusCodeTryAgainLater = 1013,
    // 1014: Reserved for future use by the WebSocket standard.
    XYJSRStatusCodeTLSHandshake = 1015,
...
@class XYJSRWebSocket;
@class XYJSRSecurityPolicy;

/**
 Error domain used for errors reported by SRWebSocket.
 */
extern NSString *const XYJSRWebSocketErrorDomain;

/**
 Key used for HTTP status code if bad response was received from the server.
 */
extern NSString *const XYJSRHTTPResponseErrorKey;

@protocol XYJSRWebSocketDelegate;
 ...
 */
@interface XYJSRWebSocket : NSObject <NSStreamDelegate>
 ...
 */
@property (nonatomic, weak) id <XYJSRWebSocketDelegate> delegate;
 ...
 */
@property (atomic, assign, readonly) XYJSRReadyState readyState;
...
/**
 ...
 @param securityPolicy Policy object describing transport security behavior.
 */
- (instancetype)initWithURLRequest:(NSURLRequest *)request protocols:(nullable NSArray<NSString *> *)protocols securityPolicy:(XYJSRSecurityPolicy *)securityPolicy NS_DESIGNATED_INITIALIZER;
 ...
 */
@protocol XYJSRWebSocketDelegate <NSObject>
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didReceiveMessage:(id)message;
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didReceiveMessageWithString:(NSString *)string;
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didReceiveMessageWithData:(NSData *)data;
 ...
 */
- (void)webSocketDidOpen:(XYJSRWebSocket *)webSocket;
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didFailWithError:(NSError *)error;
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(nullable NSString *)reason wasClean:(BOOL)wasClean;
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didReceivePingWithData:(nullable NSData *)data;
 ...
 */
- (void)webSocket:(XYJSRWebSocket *)webSocket didReceivePong:(nullable NSData *)pongData;
 ...
 */
- (BOOL)webSocketShouldConvertTextFrameToString:(XYJSRWebSocket *)webSocket NS_SWIFT_NAME(webSocketShouldConvertTextFrameToString(_:));
